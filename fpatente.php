...
<head>
    ...
    <title>Patente Artisanale</title>
                    ...
                    <div class="container text-secondary text-wrap">
                        ...
                        <fieldset>
                            ...
                            <div class="form-floating border">
                                ...
                                <label for="penalite" class="form-label">Net à payer(Patente Artisanale) en chiffre</label>
                            </div><br>  
                        </fieldset>
                        
                        <!--<div class="custom-file">-->
                        <!--    <label for="photo" class="form-label"> Prendre une photo</label>-->
                        <!--    <input type="file" class="custom-file-input" id="photo" name="photo" accept="image/*" capture="environment">-->
                        <!--</div>-->
                        <input type="hidden" name="type_pat" value="artisanale">
